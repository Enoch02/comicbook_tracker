...
import com.enoch2.comictracker.data.loadData
import com.enoch2.comictracker.layouts.ComicInfoLayout
import com.enoch2.comictracker.layouts.DrawerLayout
...
fun HomeTopAppBar(scaffoldState: ScaffoldState, scope: CoroutineScope) {
    ...
    TopAppBar(
        ...
        title = { Text(text = stringResource(R.string.my_comics)) },
        actions = {
            IconButton(
                onClick = {
